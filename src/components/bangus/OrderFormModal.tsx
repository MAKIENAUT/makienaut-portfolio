  ...
  return (
    ...
    >
      <section
        ...
        className="flex max-h-[95svh] w-full flex-col overflow-hidden rounded-t-3xl border border-white/10 bg-[#111615] shadow-2xl sm:max-w-4xl sm:rounded-3xl"
      >
        ...
        >
          <div className="space-y-6 p-5 sm:p-6">
            <label className="block">
              ...
              <input
                ...
                className="mt-2 min-h-11 w-full rounded-xl border border-white/10 bg-black/30 px-3 py-2.5 text-sm text-white outline-none placeholder:text-stone-600 focus:border-cyan-300 focus:ring-2 focus:ring-cyan-300/15"
              />
            </label>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="relative sm:w-72">
                  ...
                  <input
                    ...
                    className="min-h-10 w-full rounded-xl border border-white/10 bg-black/30 py-2 pl-10 pr-3 text-sm text-white outline-none placeholder:text-stone-600 focus:border-cyan-300"
                  />
                </div>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <input
                        ...
                        placeholder="0"
                        className="h-10 w-20 rounded-lg border border-white/10 bg-black/30 px-2 text-center text-sm font-semibold text-white outline-none focus:border-cyan-300"
                      />
                    </label>
                  );
                })}
            ...
            <section className="grid gap-4 rounded-2xl border border-white/[0.08] bg-black/20 p-4 sm:grid-cols-3">
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <input
                  ...
                  className="h-4 w-4 accent-cyan-300"
                />
                <span className="text-sm font-medium text-stone-200">Paid</span>
              </label>
              <label>
          ...
          <footer className="sticky bottom-0 flex flex-col gap-4 border-t border-white/[0.08] bg-[#111615]/95 px-5 py-4 backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <div className="flex gap-6 text-sm">
              ...
              <div>
                ...
                <p className="mt-1 font-semibold text-stone-300">
            ...
            <div className="flex flex-col-reverse gap-2 sm:flex-row">
              ...
              >
                ...
                {isSaving ? "Saving…" : order ? "Save changes" : "Add order"}
              </button>
            </div>
          </footer>
        </form>
